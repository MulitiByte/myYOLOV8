...
#sys.path.append(os.path.join(current,"/home/issiyua/Project/ambiguous/model_codes/yolox/ambiguous_detection/object_detection/Internship/ultralytics-main/ultralytics"))
...
def train(cfg=DEFAULT_CFG, use_python=False):
    ...
    data = 'D:/Internship_C/about-yolov8/ultralytics-main/ultralytics/yolo/cfg/cityspaces.yaml'
